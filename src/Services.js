    ...
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <View style={styles.buttonContainer}>
          <Btn bgColor={black} textColor="white" btnLabel="Maid" width={200} Press={handleMaidPress} />
          <Btn bgColor={black} textColor="white" btnLabel="Plumber" width={200} Press={handlePlumberPress} />
          <Btn bgColor={black} textColor="white" btnLabel="Electrician" width={200} Press={handleElectricianPress} />
        </View>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.creditItem}>Designed by Roohullah</Text>
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    justifyContent: 'flex-start', // Align buttons from top to bottom
    alignItems: 'center',
  },
  footer: {
